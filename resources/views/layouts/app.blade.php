...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <link rel="stylesheet" id="main-stylesheet" data-version="1.1.0" href="{{asset('assets/css/a/shards-dashboards.min.css')}}">
    <link rel="stylesheet" href=" {{asset('assets/css/a/extras.min.css')}}">
  ...
  <body class="h-100">
    ...
    <script src="{{asset('assets/js/a/extras.min.js')}}"></script>
    <script src="{{asset('assets/js/a/shards-dashboards.min.js')}}"></script>
    <script src="{{asset('assets/js/app/app-blog-overview.js')}}"></script>
  </body>
</html>
